...
# Temporary Archive
The project for the map extraction tool hasn't received any noticeable updates this past year, and I'm currently unable to extract map tiles beyond 1.48 for American Truck Simulator and 1.49 for Euro Truck Simulator 2. Because of this, I've decided to temporarily archive the repository.

If, in the future, something moves with the dashboard project and the map extraction tool, I will return to this and provide updated tilesets for both games. I am also highly likely to delete the Promods entirely as I personally do not use that mod because of how convoluted it is to download 10 different archive files.

One can still contact me on Discord, I will remain there if needed. But I will not provide any real support for the tiles or the dashboard project, though I can answer basic questions.
...
[Iowa]: https://store.steampowered.com/app/3025440/American_Truck_Simulator__Iowa/
